...
// Source: http://krishnalearnings.blogspot.nl/2015/08/sumset-sum-problem-java-and-backtracking.html
public class SubSetSum
{
	...
	public void findSubSets(Integer[] set, int targetSum) {
		this.set = set;
		this.numOfElements = set.length;
		this.targetSum = targetSum;
		selectedElements = new Integer[numOfElements];
		Arrays.fill(selectedElements, 0);
